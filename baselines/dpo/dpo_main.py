...
def apply_dpo_to_model(
    ...
    **kwargs: Any,
    ...
    deltas = execute_dpo(ref_model, model, tok, requests, hparams)
...
def execute_dpo(
    ...
    **kwargs: Any,
    ...
    # TODO: fix this originals
    originals = [r["target_new"]["str"] for r in requests]
    # originals = [r["target_original"]["str"] for r in requests]
    ...
    for it in range(hparams.num_steps):
        ...
        for txt, tgt in zip(
            ...
            # nucleus sampling
            gen = model.generate(input_ids=prompt_inputs['input_ids'], do_sample=True, top_p=0.95, top_k=50, num_return_sequences=32, max_length=10)
